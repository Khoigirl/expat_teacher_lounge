        ...
        {chooseContent.map((item, i) => (
          <div key={i} className="col-xl-3 col-md-6 wow fadeInDown">
            <div className="cs_card cs_style_2 cs_radius_10 position-relative overflow-hidden">
              ...
              <img src={item.img} alt="Bulb icon" />
              </span>
              <div className="cs_card_content">
                <h3 className="cs_card_title cs_fs_22 cs_semibold cs_mb_10"><Link to="/service/service-details" aria-label="Click to view service">{item.title}</Link></h3>
              ...
              <div className="cs_card_shape position-absolute start-0 top-0 z-0">
                <img src="/assets/img/service_card_shape.svg" alt="Caed shape" />
              </div>
