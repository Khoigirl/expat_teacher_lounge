            ...
            <div className="row">
              <div className="col-lg-4">
                <div className="cs_testimonial_thumbnail cs_center position-relative wow fadeInLeft">
                  <img src="/assets/img/testimonial_img.png" alt="Client image" />
                  <div className="cs_testimonial_shape_2 position-absolute">
                    <img src="/assets/img/leaves_shape.svg" alt="Shape image" />
                  </div>
                  <div className="cs_testimonial_shape_3 position-absolute">
                    <img src="/assets/img/message_shape.svg" alt="Shape image" />
                  </div>
                </div>
              </div>
              <div className="col-lg-8">
                ...
                <div className="cs_client_reviews_info position-relative text-center">
                  ...
                  <img src="/assets/img/arrow_shape.svg" alt="Arrow" className="cs_reviews_arrow position-absolute" />
                  <div className="cs_review_summery">
                    ...
                    <img src="/assets/img/stars.svg" alt="Stars group" />
