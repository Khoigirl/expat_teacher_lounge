...
const Testimonial1 = () => {
    ...
    const testimonialContent = [
        {img:'/assets/img/avatar_1.jpg', subtitle:'Acme Co.', title:'Brooklyn Simmons', content:'This team exceeded my expectations! They were punctual and meticulous. My office has looked better. Will use them again!'},
...
<section className="cs_slider cs_style_1 cs_testimonial_slider cs_slider_gap_30 position-relative">
      ...
      <div className="container">
        ...
        <div className="cs_testimonial_shape_1 position-absolute">
          <img src="/assets/img/color_glow.svg" alt="Color glow shape" />
        </div>
