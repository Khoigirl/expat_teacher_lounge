        ...
        <div className="container">
          <div className="cs_hero_content">
            <div className="cs_hero_thumbnail wow fadeInLeft">
              <img src="/assets/img/hero_img_1.jpg" alt="Hero Image" />
            ...
            <div className="cs_hero_text position-relative">
              <div className="cs_hero_shape_1 position-absolute">
                <img src="/assets/img/star_shape.svg" alt="Star image" />
              </div>
              ...
              <div className="cs_hero_text_wrapper">
                <p className="cs_hero_text cs_medium wow fadeInRight">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even</p>
                <div className="cs_hero_feature_wrapper">
                  <Link to="/about" className="cs_totating_logo cs_heading_bg cs_radius_50 position-relative wow zoomIn">
                    <img src="/assets/img/circular_text.svg" alt="Logo text" />
                    <div className="cs_logo_arrow cs_center">
                      <img src="/assets/img/icons/arrow_right.svg" alt="Arrow" />
                    </div>
                  </Link>
                  <div className="cs_sales_info_wrapper cs_heading_color">
                    <img src="/assets/img/icons/growth_balance.svg" alt="Sales growth" />
          ...
          <div className="cs_hero_sidebar">
            <div className="cs_top_content">
              <div className="cs_clients_info">
                ...
                <img src="/assets/img/video_bg_1.jpg" alt="Video bg image" className="cs_video_bg" />
                <img src="/assets/img/icons/player_1.svg" alt="Player icon" className="position-relative z-1" />
                </a>
                <div className="cs_clients_heading cs_mb_10">
                  <img src="/assets/img/icons/user_1.svg" alt="Human icon" />
                  <h3 className="cs_fs_20 mb-0">3k+ <span className="cs_fs_14 cs_medium">Satisfied client</span></h3>
                </div>
                <img src="/assets/img/users-group.png" alt="Users image" />
              </div>
            </div>
