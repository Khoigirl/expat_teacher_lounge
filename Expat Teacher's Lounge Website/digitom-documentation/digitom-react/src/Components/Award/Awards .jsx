    ...
    return (
        ...
        <div className="container">
              ...
              <div className="cs_iconbox cs_style_2">
                <div className="cs_image_layer cs_style_1">
                  <div className="cs_image_layer_in cs_radius_20">
                    <img src="/assets/img/award_1.jpg" alt="Image" />
                  </div>
                </div>
                <Link to="/service/service-details" aria-label="Click to view service" className="cs_iconbox_icon cs_center cs_radius_50">
                ...
                <div className="cs_iconbox_content">
                  ...
                  <h2 className="cs_iconbox_title cs_fs_24 cs_semibold mb-0"><Link to="/service/service-details" aria-label="Click to view service">Digital agency bring specialized</Link></h2>
                </div>
              </div>
            </div>
          ...
          <div className="cs_award_shape_1 position-absolute">
            <img src="/assets/img/spiral_1.svg" alt="Shape image" />
          </div>
          <div className="cs_award_shape_2 position-absolute">
            <img src="/assets/img/award_shape_1.svg" alt="Shape image" />
          </div>
        </div>
        <div className="cs_height_120 cs_height_lg_80"></div>
      </section>
