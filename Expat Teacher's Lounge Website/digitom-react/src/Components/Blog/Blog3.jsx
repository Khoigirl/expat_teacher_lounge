        ...
        {chooseContent.map((item, i) => (
          <div key={i} className="col-lg-4 wow fadeInLeft">
            <article className="cs_post cs_style_1 cs_type_1">
              <Link to="/blog/blog-details" aria-label="Click to read post" className="cs_post_thumbnail position-relative">
              ...
              <div className="cs_post_content cs_white_bg">
                ...
                <Link to="/blog/blog-details" aria-label="Click to read post" className="cs_post_btn cs_medium">
                  <span>Read More</span>
                  <span>
