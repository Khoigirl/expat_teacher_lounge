        ...
        {chooseContent.map((item, i) => (
          <div key={i} className="col-lg-4 wow fadeInUp">
            <article className="cs_post cs_style_2 position-relative">
              <Link to="/blog/blog-details" aria-label="Click to read post" className="cs_post_thumbnail cs_radius_15 position-relative">
              ...
              <div className="cs_post_content cs_gray_bg_1">
                ...
                <h3 className="cs_post_title cs_fs_20 cs_mb_18">
                  <Link to="/blog/blog-details" aria-label="Click to read post">{item.content}</Link>
                </h3>
                <Link to="/blog/blog-details" aria-label="Click to read post" className="cs_post_btn cs_fs_18 cs_semibold text-uppercase">
                  <span>Read More</span>
