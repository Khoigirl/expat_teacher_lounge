            ...
            {chooseContent.map((item, i) => (
              <div key={i} className="col-12">
                <div className="cs_post cs_style_1 cs_type_2 cs_radius_10 wow fadeInRight">
                  <Link to="/blog/blog-details" aria-label="Click to read post" className="cs_post_thumbnail cs_radius_8 cs_mb_26 position-relative">
                  ...
                  <div className="cs_post_content">
                    <div className="cs_post_meta_wrapper cs_fs_14 cs_medium cs_mb_11">
                      <div className="cs_post_meta">
                        <span className="cs_blue_color">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.5442 5.19275C14.5442 7.69093 12.4996 9.7355 10.0014 9.7355C7.50329 9.7355 5.45872 7.69093 5.45872 5.19275C5.45872 2.69457 7.50326 0.65 10.0014 0.65C12.4996 0.65 14.5442 2.69458 14.5442 5.19275Z" stroke="currentColor" stroke-width="1.3"></path>
                      ...
                      <div className="cs_post_meta">
                        <span className="cs_blue_color">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_235_1708)">
                    ...
                    <h3 className="cs_post_title cs_fs_24 cs_mb_14">
                      <Link to="/blog/blog-details" aria-label="Click to read post">{item.title}</Link>
                    </h3>
                    <p className="cs_post_subtitle cs_mb_23">{item.content}</p>
                    <Link to="/blog/blog-details" aria-label="Click to read post" className="cs_post_btn cs_fs_14 cs_semibold cs_radius_5">
                      <span>Read More</span>
                      <span>
