          ...
          <div className="row cs_row_gap_30 cs_gap_y_60">
                ...
                <div className="cs_sidebar_widget cs_gray_bg_1 cs_radius_10 wow fadeInDown">
                  ...
                  <div className="cs_recent_post_wrapper">
                    <div className="cs_recent_post">
                      ...
                      <img src="/assets/img/latest_post_1.jpg" alt="Recent Post Image" />
                      </a>
                    ...
                    <div className="cs_recent_post">
                      <a className="cs_recent_post_thumb cs_radius_10" href="#" aria-label="Click to read post">
                      <img src="/assets/img/latest_post_2.jpg" alt="Recent Post Image" />
                      </a>
                      <div className="cs_recent_post_right">
                        <div className="cs_post_meta cs_fs_14 cs_blue_color cs_mb_9">
                    ...
                    <div className="cs_recent_post">
                      <a className="cs_recent_post_thumb cs_radius_10" href="#" aria-label="Click to read post">
                      <img src="/assets/img/latest_post_3.jpg" alt="Recent Post Image" />
                      </a>
                      <div className="cs_recent_post_right">
                        <div className="cs_post_meta cs_fs_14 cs_blue_color cs_mb_9">
            ...
            <div className="col-xl-8 col-lg-7">
              <div className="cs_post_details">
                <img src="/assets/img/post_banner.jpg" alt="Post Banner" className="wow fadeInRight" />
                ...
                <div className="row cs_row_gap_30 cs_gap_y_30 cs_mb_33">
                  <div className="col-md-6 wow fadeInLeft">
                    <img src="/assets/img/post_gallery_1.jpg" alt="Post gallery image" className="w-100 h-100 cs_radius_15" />
                  </div>
                  <div className="col-md-6 wow fadeInRight">
                    <img src="/assets/img/post_gallery_2.jpg" alt="Post gallery image" className="w-100 h-100 cs_radius_15" />
                  </div>
                </div>
              ...
              <div className="cs_author_card cs_radius_15 wow fadeInDown">
                <div className="cs_author_thumbnail cs_radius_15">
                  <img src="/assets/img/post_author.jpg" alt="Author image" />
                </div>
                ...
                <ul className="cs_comment_list cs_heading_font cs_mp_0">
                  <li className="cs_comment_body position-relative">
                    <div className="cs_comment_thumbnail cs_radius_15">
                      <img src="/assets/img/client_1.jpg" alt="Client image" />
                    </div>
                  ...
                  <li className="cs_comment_body position-relative">
                    <div className="cs_comment_thumbnail cs_radius_15">
                      <img src="/assets/img/client_2.jpg" alt="Client image" />
                    </div>
                    <div className="cs_comment_info">
                      <p className="cs_fs_14 cs_medium mb-0">15 Jun, 2024</p>
                  ...
                  <li className="cs_comment_body position-relative">
                    <div className="cs_comment_thumbnail cs_radius_15">
                      <img src="/assets/img/client_3.jpg" alt="Client image" />
                    </div>
                    <div className="cs_comment_info">
                      <p className="cs_fs_14 cs_medium mb-0">15 Jun, 2024</p>
