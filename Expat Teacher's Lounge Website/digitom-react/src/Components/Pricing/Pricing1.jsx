    ...
    return (
        <section className="cs_tabs cs_gray_bg_1 position-relative">
            ...
            <div className="container">
                ...
                <img src="/assets/img/about_shape_3.svg" alt="Shape image" />
                </div>
                <div className="cs_pricing_shape_2 position-absolute">
                <img src="/assets/img/pricing_shape_1.svg" alt="Shape image" />
                </div>
                <div className="cs_pricing_shape_3 position-absolute">
                <img src="/assets/img/pricing_shape_2.svg" alt="Shape image" />
                </div>
                <div className="cs_pricing_shape_4 position-absolute">
                <img src="/assets/img/pricing_shape_3.svg" alt="Shape image" />
                </div>
            </div>
            <div className="cs_height_120 cs_height_lg_80"></div>
            </section>
